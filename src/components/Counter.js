...
export default function Counter() {
  ...
  return (
    <div className='widget-counter container'>
      ...
      <div>
        <button id='increment' onClick={e=>setCount(count+1)}>Increment</button>
        <button id='decrement' onClick={e=>setCount(count-1)}>Decrement</button>
        <button id='resetCount' onClick={e=>setCount(0)}>Reset</button>
      </div>
    </div>
  );
}
