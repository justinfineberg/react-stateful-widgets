 ...
 const [mood, setMood] = useState(initialMood)
  ...
  return (
    <div className='widget-moods container'>
      ...
      <div>
        <button id='makeHappy' onClick={e=>setMood(happyMood)}>Make Happy</button>
        <button id='makeSad' onClick={e=>setMood(sadMood)}>Make Sad</button>
        <button id='resetMood' onClick={e=>setMood(initialMood)}>Reset</button>
      </div>
    </div>
  );
}
